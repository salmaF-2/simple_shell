...
/**
 * env_b - Prints all the environmental
...
/**
 * check_built_ins - Finds the
 * right function needed for execution.
 * @str: The name of the function that is needed.
 * Return: Upon sucess a pointer to a void
